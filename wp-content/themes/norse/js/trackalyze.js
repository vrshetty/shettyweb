...
var linkreefer = "//t6.trackalyzer.com/trackalyze.asp?r=" + myref + "&p=" + mypage + "&i=" + myid + "&llnocookies=" + llnocookies;
...
function Trackalyzer (myid, page, forward, open)
{
	...
	var linkreefer = "//t9.trackalyzer.com/trackalyze.asp?i=" + myid + "&r=" + myref + "&p=" + mypage + "&f=" + forward;
